<template>
  <div
    v-if="event_data.MenuTimeStart != null"
    class="w-full max-w-screen-xl py-2 mx-auto mb-5 text-center bg-primary bg-opacity-20"
  >
...
export default {
  ...
  mounted() {
    this.event_data && this.event_data.MenuTimeStart != null
      ? this.SetTimer()
      : '';
  },
  computed: {
